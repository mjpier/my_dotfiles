...
/*static char *font2[] = { "Symbols Nerd Font:size=12:antialias=true:autohint=true" };*/
...
static Shortcut shortcuts[] = {
    ...
    { ControlMask,          XK_equal,       kscrollup,      {.i =  1} },
    { ControlMask,          XK_minus,       kscrolldown,    {.i =  1} },
